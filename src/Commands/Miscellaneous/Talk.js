...
module.exports = {
    ...
    run: async (client, message, args, distube) => {
        ...
        .setColor('RED')
        .setDescription('<:dau_x:948505103030165544> Bạn phải vào voice mới nghe mình nói được chứ!')
        ...
        .setColor('RED')
        .setDescription('<:dau_x:948505103030165544> Bạn chưa nói với tui bạn muốn nói gì?')
        ...
        .setColor('RED')
        .setDescription('<:dau_x:948505103030165544> Bạn viết dài quá! Dỗi không thèm đọc >:l')
